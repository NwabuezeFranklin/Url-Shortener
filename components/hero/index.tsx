...
const HeroPage = () => {
  return (
    <section
      id="hero"
      className="relative w-full bg-heroBg pt-[130px] bg-no-repeat bg-cover bg-center text-center flex flex-col justify-center items-center px-8 lg:px-[93px] lg:pt-[146px]"
    >
